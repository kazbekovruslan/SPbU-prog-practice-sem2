...
Решение второй задачи оценивается по шкале от 0 (нет решения или решение имеет существенные недостатки) до 6 (решение работоспособно, аккуратно реализовано, алгоритмически аккуратно).
...
1. 
    Реализовать в виде класса структуру данных "Бор" (link). Должны быть поддержаны следующие методы:
...
Решение первой задачи оценивается по шкале от 0 (нет решения или решение имеет существенные недостатки) до 5 (решение работоспособно, аккуратно реализовано, алгоритмически аккуратно).
...
2.
    Решение первой задачи оценивается по шкале от 0 (нет решения или решение имеет существенные недостатки) до 2 (решение работоспособно, аккуратно реализовано,         алгоритмически аккуратно).
...
Решение второй задачи оценивается по шкале от 0 (нет решения или решение имеет существенные недостатки) до 3 (решение работоспособно, аккуратно реализовано, алгоритмически аккуратно).
...
1. 
    ...
    Сборка и запуск юнит-тестов на GitHub Actions, лицензия и README в корне репозитория для этой задачи обязательны.

Решение первой задачи оценивается по шкале от 0 (нет решения или решение имеет существенные недостатки) до 7 (решение работоспособно, аккуратно реализовано, алгоритмически аккуратно).
...
2. 
    ...
    В качестве альтернативы предлагаю самостоятельно придумать игру с консольным интерфейсом, написать об этом мне. Если идея будет содержательно, то можно будет           выполнить собственную задачу, а также +1 балл за инициативность.

Решение второй задачи оценивается по шкале от 0 (нет решения или решение имеет существенные недостатки) до 4 (решение работоспособно, аккуратно реализовано, алгоритмически аккуратно).
